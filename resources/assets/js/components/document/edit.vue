                            ...
                            <tr v-for="(row, index) in subDocuments">
                                ...
                                <td>
                                    <input
                                        ...
                                        v-model="row.document_title"
                                        disabled
                                    >
                                </td>
                                <td>
                                    <a
                                        v-on:click="removeSubDocument(row,index);"
...
export default {
    ...
    methods: {
        ...
        validate() {
            if (this.list.document_title && this.list.document_type_id)
                return this.save();
            this.errors = [];
            this.$message({
                type: "error",
        ...
        addSubDocuments: function(row, index) {
            ...
            if (index !== undefined) {
                axios
                    ...
                    .then(response => {
                        this.subDocuments[index].document_title =
