        ...
        <datatable :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy">
            <tbody>
                <tr v-for="item in documents" :key="item.barcode">
                    ...
                    <td v-if="item.document.approved_po==1"><button class="btn btn-default btn-sm" @click="approvedPo(item.document.id, 0)" title="Revert tag approved PO">
                    ...
                    <td v-else><button class="btn btn-success btn-sm" @click="approvedPo(item.document.id, 1)" title="Tag as approve PO">
